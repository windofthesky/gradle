...
class StatusPostfixLogHeaderFormatterTest extends Specification {
    ...
    def "does not render null status"() {
        ...
        then:
        rendered(output) == """<Normal>DESCRIPTION</Normal><Normal>
</Normal>"""
    }
    ...
    def "prefers header for rendering"() {
        ...
        then:
        rendered(output) == """<Normal>HEADER </Normal><ProgressStatus>STATUS</ProgressStatus><Normal>
</Normal>"""
    }
    ...
    def "prefers short description over description"() {
        ...
        then:
        rendered(output) == """<Normal>SHORT</Normal><Normal>
</Normal>"""
    }
