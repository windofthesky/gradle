...
class DefaultPlayToolProviderTest extends Specification {
    ...
    def "provides playRunner for play #playVersion"(){
        ...
        when:
        playToolProvider = new DefaultPlayToolProvider(fileResolver, workerDaemonFactory, workerDirectoryProvider, workerProcessBuilderFactory, playPlatform, twirlClasspath, routesClasspath, javascriptClasspath)
