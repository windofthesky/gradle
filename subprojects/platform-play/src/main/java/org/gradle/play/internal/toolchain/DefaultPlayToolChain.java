...
public class DefaultPlayToolChain implements PlayToolChainInternal {
    ...
    public DefaultPlayToolChain(FileResolver fileResolver, WorkerDaemonFactory workerDaemonFactory, WorkerDirectoryProvider workerDirectoryProvider, ConfigurationContainer configurationContainer, DependencyHandler dependencyHandler, WorkerProcessFactory workerProcessBuilderFactory) {
    ...
    public PlayToolProvider select(PlayPlatform targetPlatform) {
        try {
            ...
            return new DefaultPlayToolProvider(fileResolver, workerDaemonFactory, workerDirectoryProvider, workerProcessBuilderFactory, targetPlatform, twirlClasspath, routesClasspath, javascriptClasspath);
